...
public class PathHelper
{
    ...
    public static string fileReadBase64(string FilePath)
    {
        byte[] binaryData;
    ...
    public static bool fileWriteBase64(string path, string base64)
    {
    ...
    public static string WebPathCombine(params string[] values)
    {
        ...
        if (values == null)
            throw new NullReferenceException("Yol boþ olamaz!");
    ...
    public static string TxtReader(string path, bool mailgonder = true, bool dosyayaz = true)
    {
        if (File.Exists(path))
        {
            FileStream dosyaAkim = new FileStream(path, FileMode.Open, FileAccess.Read);

            StreamReader okuyucu = new StreamReader(dosyaAkim, Encoding.GetEncoding(1254));
    ...
    public static string TxtReaderUTF8(string path, bool mailgonder = true, bool dosyayaz = true)
    {
        if (File.Exists(path))
        {
            FileStream dosyaAkim = new FileStream(path, FileMode.Open, FileAccess.Read);

            StreamReader okuyucu = new StreamReader(dosyaAkim, Encoding.UTF8);
    ...
    public static List<string> TxtReaderLargeFile(string filename)
    {
        ...
        using (StreamReader sr = new StreamReader(bs, Encoding.GetEncoding(1254)))
        {
            string line;
    ...
    public static bool DosyayaYaz(string path, string icerik, bool directorycreate = false)
    {
        return DosyayaYazEncoding(path, icerik, Encoding.GetEncoding(1254), directorycreate);
    }
    public static bool DosyayaYazUtf8(string path, string icerik, bool directorycreate = false)
    {
        return DosyayaYazEncoding(path, icerik, Encoding.UTF8, directorycreate);
    }
    public static bool DosyayaYazEncoding(string path, string icerik, Encoding encode, bool directorycreate = false)
    {
        try
        {
            if (directorycreate)
            ...
            FileStream dosyaAkim = new FileStream(path, FileMode.Create, FileAccess.Write);

            StreamWriter yazici = new StreamWriter(dosyaAkim, encode);

            yazici.WriteLine(icerik);
    ...
    public static bool DosyayaYazAltAlta(string path, string icerik, bool directorycreate = false)
    {
        ...
        try
        {
            ...
            builder.AppendLine("*******************************************************");
            builder.AppendLine(String.Format("{0}{2}{1}{2}", DateTime.Now.ToString(), icerik, Environment.NewLine));
            builder.AppendLine("*******************************************************");

            //File.WriteAllText(path, builder.ToString(), Encoding.GetEncoding(1254));

            //StreamWriter yazici = new StreamWriter(path, true, Encoding.GetEncoding(1254));
            //yazici.WriteLine(Environment.NewLine);
            //yazici.Write(builder.ToString());
            //yazici.WriteLine(Environment.NewLine);
            //yazici.Close();
    ...
    public static bool DosyayaYazAltAltaAyiracsiz(string path, string icerik, bool directorycreate = false)
    {
        try
        {
            if (directorycreate)
            ...
            builder.Append(String.Format("{0}", icerik));
    ...
    public static void DirectoryYoksaOlustur(string path)
    {
        try
        {
            if (Directory.Exists(Path.GetDirectoryName(path)) == false)
    ...
    public static bool DosyayaYazUtf8StringBuilder(string path, StringBuilder icerik, bool directorycreate = false)
    {
        return DosyayaYazEncodingStringBuilder(path, icerik, Encoding.UTF8, directorycreate);
    }
    public static bool DosyayaYazEncodingStringBuilder(string path, StringBuilder icerik, Encoding encode, bool directorycreate = false)
    {
        try
        {
            if (directorycreate)
    ...
    public static bool DosyayaYazCdr(string path, string icerik)
    {
        try
        {
            ...
            StreamWriter yazici = new StreamWriter(dosyaAkim, Encoding.GetEncoding("ISO-8859-9"));
    ...
    public static bool DosyayaYazTemizleOnce(string path, string icerik)
    {
        try
        {

            FileStream dosyaAkim = new FileStream(path, FileMode.Truncate, FileAccess.Write);

            StreamWriter yazici = new StreamWriter(dosyaAkim, Encoding.GetEncoding(1254));
